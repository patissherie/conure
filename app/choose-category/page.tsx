...
const OPTIONS: { id: Category; emoji: string; title: string; description: string }[] = [
  { id: 'food', emoji: '🍔', title: 'Food', description: 'Restaurants, cafés and places to eat.' },
  { id: 'activity', emoji: '🎯', title: 'Activity', description: 'Fun things to do together.' },
  { id: 'surprise', emoji: '🎲', title: 'Surprise Me', description: 'Let Huddle choose anything.' },
]
