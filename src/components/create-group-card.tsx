      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="mt-8 w-full rounded-2xl border-2 border-dashed border-primary bg-secondary px-6 py-6">
          ...
          <Button
            type="button"
            onClick={copyCode}
            className="mt-6 h-12 w-full gap-2 rounded-2xl bg-primary"
          >
            {copied ? (
              <>
          ...
          <Link
            href="/dashboard"
            className="mt-4 inline-flex h-12 w-full items-center justify-center rounded-2xl border border-border font-semibold hover:bg-accent"
          >
            Go to Dashboard
          </Link>
        </div>
